    ...
    <div class="file-upload">
        ...
        <div :class="['upload-container', {'upload-container__show': open}]">
            <div class="img-container" v-if="!!path">
                <div class="current-img">
                    <a :href="path" target="_blank">
                        <i class="ri-file-pdf-2-line" v-if="path.toLowerCase().includes('pdf')"></i>
            ...
            <div class="single-img" v-else>
                ...
                <label :for="`file-${props.document.type}`" class="label-file" v-if="!url" >
                ...
                <input type="file" @change="handleFileUpload" class="file-input-hide" :id="`file-${props.document.type}`">
